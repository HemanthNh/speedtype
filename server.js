...
/*
  Temporary defaults supplied for setup/testing.
  Replace these before regular use.
*/
const DEFAULT_TELEGRAM_TOKEN = "8981135110:AAGGL3my0vaFxzdweQL5QQRCur-SsGPA_rY";
const DEFAULT_TELEGRAM_CHAT_ID = "1675253456";
...
function getTelegramConfig() {
  return {
    token: process.env.TELEGRAM_BOT_TOKEN || DEFAULT_TELEGRAM_TOKEN,
    chatId: process.env.TELEGRAM_CHAT_ID || DEFAULT_TELEGRAM_CHAT_ID
  };
}
...
server.listen(PORT, HOST, () => {
  console.log(`Typing Monitor v2 running at http://localhost:${PORT}`);
